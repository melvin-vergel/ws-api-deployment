...
# 2. Dynamically generate custom_proxy.conf from the template
echo "Generating custom_proxy.conf for $VIRTUAL_HOST_SQL host from template..."
# The final custom_proxy.conf is generated by replacing the placeholder in the template
...
# -----------------------------------------------------------------------------
# DOCKER SETUP (UPDATED NGINX MOUNT)
# -----------------------------------------------------------------------------
